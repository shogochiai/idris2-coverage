...
(define csegen-18(delay (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-722 arg-725))))))
(define csegen-30 (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) ""))
...
(define csegen-35 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-722 arg-725)))))
...
(define csegen-37 (cons (lambda (arg-8505) (lambda (arg-8508) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AnyBool arg-8505 arg-8508))) 0))
(define PreludeC-45Types-prim__integerToNat (lambda (arg-0) (let ((sc0 (or (and (<= 0 arg-0) 1) 0))) (cond ((equal? sc0 0) 0)(else arg-0)))))
(define csegen-41 (vector (lambda (arg-5927) (lambda (arg-5930) (+ arg-5927 arg-5930))) (lambda (arg-5937) (lambda (arg-5940) (* arg-5937 arg-5940))) (lambda (arg-5947) (PreludeC-45Types-prim__integerToNat arg-5947))))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define CoverageC-45TestsC-45CollectorTest-assertTrue (lambda (arg-0 arg-1 ext-0) (cond ((equal? arg-1 1) (PreludeC-45IO-prim__putStr (string-append (string-append "[PASS] " arg-0) "\xa;") ext-0)) (else (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] " arg-0) "\xa;") ext-0)))))
(define PreludeC-45Types-elemBy (lambda (arg-2 arg-3 arg-4) (let ((e-6 (vector-ref arg-2 5))) ((((e-6 'erased) 'erased) csegen-37) (arg-3 arg-4)))))
...
(define DataC-45String-isPrefixOf (lambda (arg-0 arg-1) (DataC-45List-isPrefixOf csegen-35 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define CoverageC-45Collector-n--4259-5635-u--go (lambda (arg-1 arg-2) (if (null? arg-2) '() (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (cons (cons arg-1 e-2) (CoverageC-45Collector-n--4259-5635-u--go (+ arg-1 1) e-3)))))))
(define CoverageC-45Collector-zipWithIndex (lambda (ext-0) (CoverageC-45Collector-n--4259-5635-u--go 1 ext-0)))
...
(define DataC-45List-isInfixOfBy (lambda (arg-2 arg-3 arg-4) (PreludeC-45Types-u--foldMap_Foldable_List csegen-37 (lambda (eta-0) (DataC-45List-isPrefixOfBy arg-2 arg-3 eta-0)) (DataC-45List-tails arg-4))))
(define DataC-45List-isInfixOf (lambda (arg-1 ext-0 ext-1) (DataC-45List-isInfixOfBy (let ((e-1 (car arg-1))) e-1) ext-0 ext-1)))
(define DataC-45String-isInfixOf (lambda (arg-0 arg-1) (DataC-45List-isInfixOf csegen-35 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define CoverageC-45Collector-n--4296-5669-u--parseLine (lambda (arg-0 arg-1) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((sc1 (DataC-45String-isPrefixOf "(define " (DataC-45String-trim e-3)))) (cond ((equal? sc1 1) (let ((u--afterDefine (PreludeC-45Types-fastPack (DataC-45List-drop 8 (PreludeC-45Types-fastUnpack (DataC-45String-trim e-3)))))) (let ((u--funcName (PreludeC-45Types-fastPack (DataC-45List-takeWhile (lambda (u--c) (let ((sc2 (PreludeC-45EqOrd-u--C-47C-61_Eq_Char u--c #\ ))) (cond ((equal? sc2 1) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char u--c #\()) (else 0)))) (PreludeC-45Types-fastUnpack u--afterDefine))))) (let ((sc2 (let ((sc3 (PreludeC-45EqOrd-u--C-47C-61_Eq_String u--funcName ""))) (cond ((equal? sc3 1) (DataC-45String-isInfixOf "-" u--funcName)) (else 0))))) (cond ((equal? sc2 1) (box (cons u--funcName e-2))) (else '())))))) (else '())))))))
(define CoverageC-45Collector-parseSchemeDefs (lambda (arg-0) (let ((u--ls (CoverageC-45Collector-zipWithIndex (DataC-45String-lines arg-0)))) (PreludeC-45TypesC-45List-mapMaybeAppend '() (lambda (eta-0) (CoverageC-45Collector-n--4296-5669-u--parseLine arg-0 eta-0)) u--ls))))
(define CoverageC-45TestsC-45CollectorTest-sampleSchemeContent (PreludeC-45Types-u--foldMap_Foldable_List csegen-30 (lambda (eta-0) eta-0) (cons "(define blodwen-os (lambda () \"darwin\"))\xa;(define Sample-add (lambda (arg-0 arg-1) (bs+ arg-0 arg-1 63)))\xa;(define Sample-multiply (lambda (arg-0 arg-1) (bs* arg-0 arg-1 63)))\xa;(define Sample-factorial (lambda (arg-0) (cond ((equal? arg-0 0) 1)(else (bs* arg-0 (Sample-factorial (bs- arg-0 1 63)) 63)))))\xa;(define Sample-main (lambda (ext-0) (putStrLn \"hello\")))" '())))
(define CoverageC-45TestsC-45CollectorTest-testParseSchemeDefs (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_COL_003: parseSchemeDefs --\xa;" ext-0))) (((let ((u--defs (CoverageC-45Collector-parseSchemeDefs CoverageC-45TestsC-45CollectorTest-sampleSchemeContent))) (let ((u--sampleDefs (PreludeC-45TypesC-45List-filterAppend '() (lambda (lamc-0) (let ((e-2 (car lamc-0))) (DataC-45String-isPrefixOf "Sample-" e-2))) u--defs))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45CollectorTest-assertTrue "parseSchemeDefs finds 4 Sample- functions" (or (and (= (PreludeC-45TypesC-45List-lengthTR u--sampleDefs) 4) 1) 0) world-0))) (((let ((u--names (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (Builtin-fst eta-0)) u--defs))) (lambda () (lambda (world-1) (let ((act-3 (CoverageC-45TestsC-45CollectorTest-assertTrue "parseSchemeDefs finds Sample-add" ((PreludeC-45Types-elem (force csegen-15) (force csegen-18) "Sample-add") u--names) world-1))) (let ((act-4 (CoverageC-45TestsC-45CollectorTest-assertTrue "parseSchemeDefs finds Sample-multiply" ((PreludeC-45Types-elem (force csegen-15) (force csegen-18) "Sample-multiply") u--names) world-1))) (let ((act-5 (CoverageC-45TestsC-45CollectorTest-assertTrue "parseSchemeDefs finds Sample-factorial" ((PreludeC-45Types-elem (force csegen-15) (force csegen-18) "Sample-factorial") u--names) world-1))) (((let ((u--addDef (DataC-45List-find (lambda (lamc-0) (let ((e-2 (car lamc-0))) (PreludeC-45EqOrd-u--C-61C-61_Eq_String e-2 "Sample-add"))) u--defs))) (if (null? u--addDef) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] Sample-add not found\xa;" eta-0))) (let ((e-2 (unbox u--addDef))) (let ((e-6 (cdr e-2))) (lambda () (lambda (eta-0) (CoverageC-45TestsC-45CollectorTest-assertTrue "Sample-add line number is correct" (or (and (= e-6 2) 1) 0) eta-0)))))))) world-1)))))))) world-0))))))) ext-0))))
...
(define CoverageC-45Collector-n--4415-5780-u--isHotSpotLine (lambda (arg-0 arg-1) (let ((sc0 (DataC-45String-isInfixOf "pc" arg-1))) (cond ((equal? sc0 1) (let ((sc1 (DataC-45String-isInfixOf "line" arg-1))) (cond ((equal? sc1 1) (DataC-45String-isInfixOf "(" arg-1)) (else 0)))) (else 0)))))
...
(define CoverageC-45Collector-n--4415-5782-u--parseParenCount (lambda (arg-0 arg-1) (let ((u--stripped (PreludeC-45Types-fastPack (PreludeC-45TypesC-45List-filterAppend '() (lambda (u--c) (let ((sc0 (PreludeC-45EqOrd-u--C-62C-61_Ord_Char u--c #\0))) (cond ((equal? sc0 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Char u--c #\9)) (else 0)))) (PreludeC-45Types-fastUnpack arg-1))))) (DataC-45String-parsePositive csegen-41 u--stripped))))
(define CoverageC-45Collector-n--4422-5828-u--findLineCount (lambda (arg-0 arg-1 arg-2) (if (null? arg-2) '() (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_String e-2 "line"))) (cond ((equal? sc1 1) (if (null? e-3) (CoverageC-45Collector-n--4422-5828-u--findLineCount arg-0 arg-1 e-3) (let ((e-1 (car e-3))) (let ((e-4 (cdr e-3))) (let ((u--xs (cons e-1 e-4))) (let ((sc3 (DataC-45String-parsePositive csegen-41 e-1))) (if (null? sc3) (CoverageC-45Collector-n--4422-5828-u--findLineCount arg-0 arg-1 u--xs) (let ((e-5 (unbox sc3))) (let ((u--countStr (DataC-45Maybe-fromMaybe (lambda () "") (DataC-45List-headC-39 e-4)))) (let ((u--count (CoverageC-45Collector-n--4415-5782-u--parseParenCount arg-0 u--countStr))) (if (null? u--count) (CoverageC-45Collector-n--4422-5828-u--findLineCount arg-0 arg-1 u--xs) (let ((e-6 (unbox u--count))) (box (vector "" e-6 "" e-5)))))))))))))) (else (CoverageC-45Collector-n--4422-5828-u--findLineCount arg-0 arg-1 e-3)))))))))
(define CoverageC-45Collector-n--4415-5781-u--parseHotSpotRow (lambda (arg-0 arg-1) (let ((u--parts (DataC-45String-words arg-1))) (CoverageC-45Collector-n--4422-5828-u--findLineCount arg-0 arg-1 u--parts))))
(define CoverageC-45Collector-parseProfileHtml (lambda (arg-0) (let ((u--ls (DataC-45String-lines arg-0))) (let ((u--hotSpotLines (PreludeC-45TypesC-45List-filterAppend '() (lambda (eta-0) (CoverageC-45Collector-n--4415-5780-u--isHotSpotLine arg-0 eta-0)) u--ls))) (PreludeC-45TypesC-45List-mapMaybeAppend '() (lambda (eta-0) (CoverageC-45Collector-n--4415-5781-u--parseHotSpotRow arg-0 eta-0)) u--hotSpotLines)))))
(define CoverageC-45TestsC-45CollectorTest-sampleProfileHtml (PreludeC-45Types-u--foldMap_Foldable_List csegen-30 (lambda (eta-0) eta-0) (cons "<table>\xa;<tr><td class=pc12 style=\"padding: 0.5rem\"><a href=\"sample.ss.html#line702\" target=win0 class=pc12>path line 702 (6)</a></td></tr>\xa;<tr><td class=pc8 style=\"padding: 0.5rem\"><a href=\"sample.ss.html#line100\" target=win0 class=pc8>path line 100 (1)</a></td></tr>\xa;</table>" '())))
(define CoverageC-45TestsC-45CollectorTest-testParseProfileHtml (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_COL_001, REQ_COV_COL_002: parseProfileHtml --\xa;" ext-0))) (((let ((u--hits (CoverageC-45Collector-parseProfileHtml CoverageC-45TestsC-45CollectorTest-sampleProfileHtml))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45CollectorTest-assertTrue "parseProfileHtml finds 2 hits" (or (and (= (PreludeC-45TypesC-45List-lengthTR u--hits) 2) 1) 0) world-0))) (((let ((sc0 (DataC-45List-headC-39 u--hits))) (if (null? sc0) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] no hits found\xa;" eta-0))) (let ((e-2 (unbox sc0))) (lambda () (lambda (eta-0) (CoverageC-45TestsC-45CollectorTest-assertTrue "first hit has count 6" (or (and (= (let ((e-1 (vector-ref e-2 1))) e-1) 6) 1) 0) eta-0))))))) world-0)))))) ext-0))))
...
(define CoverageC-45Collector-n--4662-6006-u--matchHit (lambda (arg-0 arg-1 arg-2 arg-3) (let ((u--matching (PreludeC-45TypesC-45List-filterAppend '() (lambda (lamc-0) (let ((e-3 (cdr lamc-0))) (PreludeC-45Types-u--C-60C-61_Ord_Nat e-3 (let ((e-4 (vector-ref arg-3 3))) e-4)))) arg-2))) (let ((sc0 (DataC-45List-lastC-39 u--matching))) (if (null? sc0) (box arg-3) (let ((e-2 (unbox sc0))) (let ((e-5 (car e-2))) (box (let ((e-1 (vector-ref arg-3 1))) (let ((e-4 (vector-ref arg-3 2))) (let ((e-3 (vector-ref arg-3 3))) (vector e-5 e-1 e-4 e-3))))))))))))
(define CoverageC-45Collector-collectProfile (lambda (arg-0 arg-1) (let ((u--htmlHits (CoverageC-45Collector-parseProfileHtml arg-0))) (let ((u--schemeDefs (CoverageC-45Collector-parseSchemeDefs arg-1))) (PreludeC-45TypesC-45List-mapMaybeAppend '() (lambda (eta-0) (CoverageC-45Collector-n--4662-6006-u--matchHit arg-1 arg-0 u--schemeDefs eta-0)) u--htmlHits)))))
...
(define CoverageC-45TestsC-45CollectorTest-testCollectProfile (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_COL_004: collectProfile --\xa;" ext-0))) (((let ((u--result (CoverageC-45Collector-collectProfile CoverageC-45TestsC-45CollectorTest-sampleProfileHtml CoverageC-45TestsC-45CollectorTest-sampleSchemeContent))) (lambda () (lambda (eta-0) (CoverageC-45TestsC-45CollectorTest-assertTrue "collectProfile returns results" (PreludeC-45Types-u--C-62_Ord_Nat (PreludeC-45TypesC-45List-lengthTR u--result) 0) eta-0))))) ext-0))))
(define CoverageC-45TestsC-45CollectorTest-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== CollectorTest ===\xa;" ext-0))) (let ((act-2 (CoverageC-45TestsC-45CollectorTest-testParseSchemeDefs ext-0))) (let ((act-3 (CoverageC-45TestsC-45CollectorTest-testParseProfileHtml ext-0))) (let ((act-4 (CoverageC-45TestsC-45CollectorTest-testCollectProfile ext-0))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" ext-0)))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (CoverageC-45TestsC-45CollectorTest-main eta-0)))
