...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_AGG_001 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Test-to-function mapping\xa;" ext-0))) (((let ((u--fc (CoverageC-45Types-coveredFunction "Mod" "func" 10 (cons "REQ_001" (cons "REQ_002" '()))))) (lambda () (lambda (world-0) (let ((act-3 (let ((sc0 (or (and (= (PreludeC-45TypesC-45List-lengthTR (let ((e-8 (vector-ref u--fc 8))) e-8)) 2) 1) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Mapped function to test list\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected 2 tests\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
