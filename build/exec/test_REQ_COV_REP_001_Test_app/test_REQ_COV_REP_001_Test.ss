...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_REP_001 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: JSON output generation\xa;" ext-0))) (((let ((u--fc (CoverageC-45Types-coveredFunction "TestMod" "testFunc" 10 (cons "REQ_TEST_001" '())))) (let ((u--json (CoverageC-45Report-functionCoverageJson u--fc))) (lambda () (lambda (world-0) (let ((act-3 (let ((sc0 (let ((sc1 (DataC-45String-isInfixOf "module" u--json))) (cond ((equal? sc1 1) (let ((sc2 (DataC-45String-isInfixOf "name" u--json))) (cond ((equal? sc2 1) (DataC-45String-isInfixOf "called_by_tests" u--json)) (else 0)))) (else 0))))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] JSON contains required fields\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Missing required fields\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))) ext-0)))))
