...
(define csegen-8 (vector (lambda (arg-5927) (lambda (arg-5930) (+ arg-5927 arg-5930))) (lambda (arg-5937) (lambda (arg-5940) (* arg-5937 arg-5940))) (lambda (arg-5947) (PreludeC-45Types-prim__integerToNat arg-5947))))
...
(define Main-sampleAnnotatedHtml (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "<span class=pc2 title=\"line 10 char 1 count 5\">code</span>\xa;<span class=pc1 title=\"line 11 char 1 count 0\">uncovered</span>" '())))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_COL_004 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Expression coverage parsing\xa;" ext-0))) (((let ((u--exprs (CoverageC-45Collector-parseAnnotatedHtml Main-sampleAnnotatedHtml))) (lambda () (lambda (world-0) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Expressions parsed: " (PreludeC-45Show-u--show_Show_Nat (PreludeC-45TypesC-45List-lengthTR u--exprs))) "\xa;") world-0))) (let ((act-4 (let ((sc0 (or (and (= (PreludeC-45TypesC-45List-lengthTR u--exprs) 2) 1) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Returned expression coverage list\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected 2 expressions\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))) ext-0)))))
