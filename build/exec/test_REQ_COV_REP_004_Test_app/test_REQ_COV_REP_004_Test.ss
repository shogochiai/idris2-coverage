...
(define csegen-3 (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) ""))
...
(define CoverageC-45Report-maybeStringJson (lambda (arg-0) (if (null? arg-0) "null" (let ((e-2 (unbox arg-0))) (PreludeC-45Types-u--foldMap_Foldable_List csegen-3 (lambda (eta-0) eta-0) (cons "\"" (cons (CoverageC-45Report-escapeJson e-2) (cons "\"" '()))))))))
...
(define CoverageC-45Report-stringListJson (lambda (arg-0) (string-append "[" (string-append (PreludeC-45Types-fastConcat (DataC-45List-intersperse ", " (PreludeC-45TypesC-45List-mapAppend '() (lambda (u--s) (PreludeC-45Types-u--foldMap_Foldable_List csegen-3 (lambda (eta-0) eta-0) (cons "\"" (cons (CoverageC-45Report-escapeJson u--s) (cons "\"" '()))))) arg-0))) "]"))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_REP_004 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: File output\xa;" ext-0))) (((let ((u--fc (CoverageC-45Types-coveredFunction "Mod" "func" 10 (cons "t1" '())))) (let ((u--json (CoverageC-45Report-functionCoverageJson u--fc))) (lambda () (lambda (world-0) (let ((act-3 (let ((sc0 (PreludeC-45Types-u--C-62_Ord_Nat (PreludeC-45TypesC-45String-length u--json) 100))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Output written to file\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Output too short\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))) ext-0)))))
