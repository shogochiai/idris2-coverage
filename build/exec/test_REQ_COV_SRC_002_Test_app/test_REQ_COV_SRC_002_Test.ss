...
(define Main-sampleSource (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "module TestModule\xa;\xa;export\xa;myFunc : Int -> Int\xa;myFunc x = x + 1" '())))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_SRC_002 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: line_start and line_end extraction\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource Main-sampleSource))) (lambda () (lambda (world-0) (let ((act-3 (if (null? u--funcs) (PreludeC-45IO-prim__putStr "[FAIL] No functions found\xa;" world-0) (let ((e-1 (car u--funcs))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Function: " (let ((e-0 (vector-ref e-1 0))) e-0)) "\xa;") world-0))) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "Line start: " (PreludeC-45Show-u--show_Show_Nat (let ((e-5 (vector-ref e-1 2))) e-5))) "\xa;") world-0))) (PreludeC-45IO-prim__putStr "[PASS] Extracted line information\xa;" world-0))))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
