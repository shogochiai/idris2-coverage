...
(define csegen-13 (vector (lambda (arg-5927) (lambda (arg-5930) (+ arg-5927 arg-5930))) (lambda (arg-5937) (lambda (arg-5940) (* arg-5937 arg-5940))) (lambda (arg-5947) (PreludeC-45Types-prim__integerToNat arg-5947))))
...
(define Main-sampleProfileHtml (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "<table>\xa;<tr><td class=pc12><a href=\"sample.ss.html#line702\">path line 702 (6)</a></td></tr>\xa;<tr><td class=pc8><a href=\"sample.ss.html#line100\">path line 100 (1)</a></td></tr>\xa;</table>" '())))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_COL_001 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Parse profile.html Hot Spots table\xa;" ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (((let ((u--hits (CoverageC-45Collector-parseProfileHtml Main-sampleProfileHtml))) (let ((u--count (PreludeC-45TypesC-45List-lengthTR u--hits))) (lambda () (lambda (world-0) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "Hot spots found: " (PreludeC-45Show-u--show_Show_Nat u--count)) "\xa;") world-0))) (let ((act-5 (let ((sc0 (PreludeC-45Types-u--C-62C-61_Ord_Nat u--count 1))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Parsed hot spot entries\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected hot spots\xa;" world-0)))))) (let ((act-6 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))))) ext-0))))))
