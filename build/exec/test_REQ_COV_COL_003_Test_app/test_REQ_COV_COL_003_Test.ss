...
(define csegen-9 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-722 arg-725)))))
...
(define Main-sampleScheme (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "(define PreludeC-45Types-fastPack (lambda (x) x))\xa;(define MyModC-45Utils-helper (lambda (x) x))\xa;(define MyModC-45Utils-process (lambda (x y) (+ x y)))" '())))
...
(define DataC-45String-isInfixOf (lambda (arg-0 arg-1) (DataC-45List-isInfixOf csegen-9 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
(define DataC-45List-isPrefixOf (lambda (arg-1 ext-0 ext-1) (DataC-45List-isPrefixOfBy (let ((e-1 (car arg-1))) e-1) ext-0 ext-1)))
(define DataC-45String-isPrefixOf (lambda (arg-0 arg-1) (DataC-45List-isPrefixOf csegen-9 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_COL_003 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Parse .ss file for define patterns\xa;" ext-0))) (((let ((u--defs (CoverageC-45Collector-parseSchemeDefs Main-sampleScheme))) (lambda () (lambda (world-0) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Definitions parsed: " (PreludeC-45Show-u--show_Show_Nat (PreludeC-45TypesC-45List-lengthTR u--defs))) "\xa;") world-0))) (let ((act-4 (let ((sc0 (or (and (= (PreludeC-45TypesC-45List-lengthTR u--defs) 3) 1) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Parsed all define patterns\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected 3 definitions\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))) ext-0)))))
