...
(define csegen-7 (lambda (arg-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-0 #\:)))
...
(define Main-sampleSource (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "module TestModule\xa;\xa;export\xa;complexFunc : Int -> Int -> Int -> Int\xa;complexFunc x y z =\xa;  let a = x + y\xa;      b = y + z\xa;  in a + b" '())))
...
(define CoverageC-45SourceAnalyzer-extractSignature (lambda (arg-0) (let ((u--parts (DataC-45List-break csegen-7 (PreludeC-45Types-fastUnpack arg-0)))) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List (Builtin-snd u--parts)))) (cond ((equal? sc0 1) '()) (else (box (DataC-45String-trim (PreludeC-45Types-fastPack (DataC-45List-drop 1 (Builtin-snd u--parts)))))))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_SRC_004 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Multi-line function definitions\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource Main-sampleSource))) (lambda () (lambda (world-0) (let ((act-3 (if (null? u--funcs) (PreludeC-45IO-prim__putStr "[FAIL] No functions found\xa;" world-0) (let ((e-1 (car u--funcs))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Function: " (let ((e-0 (vector-ref e-1 0))) e-0)) "\xa;") world-0))) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "Line range: " (string-append (PreludeC-45Show-u--show_Show_Nat (let ((e-5 (vector-ref e-1 2))) e-5)) (string-append "-" (PreludeC-45Show-u--show_Show_Nat (let ((e-3 (vector-ref e-1 3))) e-3))))) "\xa;") world-0))) (PreludeC-45IO-prim__putStr "[PASS] Handled multi-line definition\xa;" world-0))))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
