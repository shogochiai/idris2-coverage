...
(define csegen-10 (lambda (arg-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-0 #\:)))
...
(define Main-sampleSource (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "module TestModule\xa;\xa;export\xa;add : Int -> Int -> Int\xa;add x y = x + y\xa;\xa;export\xa;mul : Int -> Int -> Int\xa;mul x y = x * y" '())))
...
(define CoverageC-45SourceAnalyzer-extractSignature (lambda (arg-0) (let ((u--parts (DataC-45List-break csegen-10 (PreludeC-45Types-fastUnpack arg-0)))) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List (Builtin-snd u--parts)))) (cond ((equal? sc0 1) '()) (else (box (DataC-45String-trim (PreludeC-45Types-fastPack (DataC-45List-drop 1 (Builtin-snd u--parts)))))))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_SRC_001 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Extract export declarations\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource Main-sampleSource))) (let ((u--count (PreludeC-45TypesC-45List-lengthTR u--funcs))) (lambda () (lambda (world-0) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Exported functions found: " (PreludeC-45Show-u--show_Show_Nat u--count)) "\xa;") world-0))) (let ((act-4 (let ((sc0 (PreludeC-45Types-u--C-62C-61_Ord_Nat u--count 1))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Found exported functions\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected exported functions\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))))) ext-0)))))
