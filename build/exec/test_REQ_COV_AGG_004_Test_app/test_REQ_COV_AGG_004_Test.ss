...
(define csegen-6 (vector (lambda (arg-5927) (lambda (arg-5930) (+ arg-5927 arg-5930))) (lambda (arg-5937) (lambda (arg-5940) (* arg-5937 arg-5940))) (lambda (arg-5947) (PreludeC-45Types-prim__integerToNat arg-5947))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_AGG_004 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Module/project aggregation\xa;" ext-0))) (((let ((u--exprs (CoverageC-45Collector-parseAnnotatedHtml "<span title=\"line 1 char 1 count 5\">x</span>"))) (let ((u--grouped (CoverageC-45Collector-groupByLine u--exprs))) (lambda () (lambda (world-0) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Grouped lines: " (PreludeC-45Show-u--show_Show_Nat (PreludeC-45TypesC-45List-lengthTR u--grouped))) "\xa;") world-0))) (let ((act-4 (let ((sc0 (PreludeC-45Types-u--C-62C-61_Ord_Nat (PreludeC-45TypesC-45List-lengthTR u--grouped) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Aggregated coverage data\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Aggregation failed\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))))) ext-0)))))
