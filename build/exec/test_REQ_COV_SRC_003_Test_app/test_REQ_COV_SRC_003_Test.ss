...
(define csegen-8 (lambda (arg-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-0 #\:)))
...
(define Main-sampleSource (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "module TestModule\xa;\xa;export\xa;calculate : Int -> Int -> Int\xa;calculate x y = x + y" '())))
...
(define CoverageC-45SourceAnalyzer-extractSignature (lambda (arg-0) (let ((u--parts (DataC-45List-break csegen-8 (PreludeC-45Types-fastUnpack arg-0)))) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List (Builtin-snd u--parts)))) (cond ((equal? sc0 1) '()) (else (box (DataC-45String-trim (PreludeC-45Types-fastPack (DataC-45List-drop 1 (Builtin-snd u--parts)))))))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_SRC_003 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Extract function signatures\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource Main-sampleSource))) (lambda () (lambda (world-0) (let ((act-3 (if (null? u--funcs) (PreludeC-45IO-prim__putStr "[FAIL] No functions found\xa;" world-0) (let ((e-1 (car u--funcs))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Function: " (let ((e-0 (vector-ref e-1 0))) e-0)) "\xa;") world-0))) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "Signature: " (DataC-45Maybe-fromMaybe (lambda () "none") (let ((e-6 (vector-ref e-1 1))) e-6))) "\xa;") world-0))) (((let ((sc1 (DataC-45Maybe-isJust (let ((e-6 (vector-ref e-1 1))) e-6)))) (cond ((equal? sc1 1) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[PASS] Extracted signature\xa;" eta-0)))) (else (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] No signature found\xa;" eta-0))))))) world-0))))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
