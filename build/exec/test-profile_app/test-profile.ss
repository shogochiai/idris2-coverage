...
(define Main-case--main-9559 (lambda (arg-0 arg-1 arg-2) (if (null? arg-2) (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] Failed to parse hit count\xa;" eta-0)) (let ((e-1 (unbox arg-2))) (cond ((equal? e-1 0) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") eta-0)))(else (let ((e-3 (- e-1 1))) (cond ((equal? e-3 0) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") eta-0)))(else (let ((e-4 (- e-3 1))) (cond ((equal? e-4 0) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") eta-0)))(else (let ((e-5 (- e-4 1))) (cond ((equal? e-5 0) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") eta-0)))(else (let ((e-6 (- e-5 1))) (cond ((equal? e-6 0) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") eta-0)))(else (let ((e-7 (- e-6 1))) (cond ((equal? e-7 0) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") eta-0)))(else (let ((e-8 (- e-7 1))) (lambda (clam-0) (cond ((equal? e-8 0) (PreludeC-45IO-prim__putStr "[PASS] Parsed hit count 6 correctly\xa;" clam-0))(else (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] Expected 6, got " (PreludeC-45Show-u--show_Show_Nat e-1)) "\xa;") clam-0))))))))))))))))))))))))))
...
(define Main-parseNum (lambda (arg-0 arg-1) (if (null? arg-0) '() (let ((e-2 (car arg-0))) (let ((e-3 (cdr arg-0))) (cond ((equal? e-2 #\)) (box arg-1))(else (let ((sc1 (PreludeC-45Types-isDigit e-2))) (cond ((equal? sc1 1) (Main-parseNum e-3 (+ (* arg-1 10) (PreludeC-45Types-prim__integerToNat (bs- (cast-char-boundedInt e-2 63) (cast-char-boundedInt #\0 63) 63))))) (else '()))))))))))
(define Main-findParen (lambda (arg-0) (if (null? arg-0) '() (let ((e-2 (car arg-0))) (let ((e-3 (cdr arg-0))) (cond ((equal? e-2 #\() (Main-parseNum e-3 0))(else (Main-findParen e-3))))))))
(define Main-parseHitCount (lambda (arg-0) (Main-findParen (PreludeC-45Types-fastUnpack arg-0))))
...
(define Main-isHotSpotLine (lambda (arg-0) (let ((sc0 (DataC-45String-isInfixOf "class=pc" arg-0))) (cond ((equal? sc0 1) (DataC-45String-isInfixOf "line" arg-0)) (else 0)))))
...
(define Main-countHotSpots (lambda (arg-0) (PreludeC-45TypesC-45List-lengthTR (PreludeC-45TypesC-45List-filterAppend '() (lambda (eta-0) (Main-isHotSpotLine eta-0)) (DataC-45String-lines arg-0)))))
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_COL_001 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Parse profile.html Hot Spots table\xa;" ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (((let ((u--count (Main-countHotSpots Main-sampleProfileHtml))) (lambda () (lambda (world-0) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "Hot spots found: " (PreludeC-45Show-u--show_Show_Nat u--count)) "\xa;") world-0))) (let ((act-5 (let ((sc0 (or (and (= u--count 2) 1) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Found expected 2 hot spot entries\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected 2 hot spots\xa;" world-0)))))) (let ((act-6 ((Main-case--main-9559 u--count "<a href=\"sample.ss.html#line702\">path line 702 (6)</a>" (Main-parseHitCount "<a href=\"sample.ss.html#line702\">path line 702 (6)</a>")) world-0))) (let ((act-7 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))))) ext-0))))))
