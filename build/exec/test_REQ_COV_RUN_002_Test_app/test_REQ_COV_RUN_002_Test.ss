...
(define csegen-3 (lambda (arg-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-0 #\:)))
...
(define CoverageC-45SourceAnalyzer-extractSignature (lambda (arg-0) (let ((u--parts (DataC-45List-break csegen-3 (PreludeC-45Types-fastUnpack arg-0)))) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List (Builtin-snd u--parts)))) (cond ((equal? sc0 1) '()) (else (box (DataC-45String-trim (PreludeC-45Types-fastPack (DataC-45List-drop 1 (Builtin-snd u--parts)))))))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_RUN_002 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Profile compilation\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource "module T\xa;\xa;export\xa;f : Int\xa;f = 1"))) (lambda () (lambda (world-0) (let ((act-3 (let ((sc0 (PreludeC-45Types-u--C-62C-61_Ord_Nat (PreludeC-45TypesC-45List-lengthTR u--funcs) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Source analysis for compilation works\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Analysis failed\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
