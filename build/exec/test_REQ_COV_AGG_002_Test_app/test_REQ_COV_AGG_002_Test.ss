...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_AGG_002 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Coverage percent computation\xa;" ext-0))) (((let ((u--fc (CoverageC-45Types-coveredFunction "Mod" "func" 10 (cons "t1" '())))) (lambda () (lambda (world-0) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "Coverage percent: " (PreludeC-45Show-u--show_Show_Double (let ((e-7 (vector-ref u--fc 7))) e-7))) "\xa;") world-0))) (let ((act-4 (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Double (let ((e-7 (vector-ref u--fc 7))) e-7) 100.0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Computed 100% coverage\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected 100%\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0))))))) ext-0)))))
