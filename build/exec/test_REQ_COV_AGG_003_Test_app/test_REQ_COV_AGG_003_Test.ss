...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_AGG_003 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Dead code detection\xa;" ext-0))) (((let ((u--fc (CoverageC-45Types-uncoveredFunction "Mod" "deadFunc"))) (lambda () (lambda (world-0) (let ((act-3 (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Double (let ((e-7 (vector-ref u--fc 7))) e-7) 0.0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Detected uncovered function\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Expected 0%\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
