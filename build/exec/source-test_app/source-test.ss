...
(define csegen-1(delay (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] add not found\xa;" eta-0))))
...
(define csegen-3 (lambda (u--f) (PreludeC-45EqOrd-u--C-61C-61_Eq_String (let ((e-0 (vector-ref u--f 0))) e-0) "add")))
...
(define csegen-28(delay (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-722 arg-725))))))
...
(define csegen-39 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-722 arg-725)))))
...
(define csegen-41 (cons (lambda (arg-8505) (lambda (arg-8508) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AnyBool arg-8505 arg-8508))) 0))
(define csegen-44 (lambda (arg-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-0 #\:)))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue (lambda (arg-0 arg-1 ext-0) (cond ((equal? arg-1 1) (PreludeC-45IO-prim__putStr (string-append (string-append "[PASS] " arg-0) "\xa;") ext-0)) (else (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] " arg-0) "\xa;") ext-0)))))
...
(define CoverageC-45TestsC-45SourceAnalyzerTest-case--testMultiLine-9662 (lambda (arg-0 arg-1) (if (null? arg-1) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] factorial not found\xa;" eta-0))) (let ((e-2 (unbox arg-1))) (let ((u--span (PreludeC-45Types-prim__integerToNat (- (let ((e-3 (vector-ref e-2 3))) e-3) (+ (let ((e-5 (vector-ref e-2 2))) e-5) 1))))) (lambda () (lambda (eta-0) (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "factorial spans multiple lines" (PreludeC-45Types-u--C-62C-61_Ord_Nat u--span 2) eta-0))))))))
...
(define DataC-45List-isInfixOfBy (lambda (arg-2 arg-3 arg-4) (PreludeC-45Types-u--foldMap_Foldable_List csegen-41 (lambda (eta-0) (DataC-45List-isPrefixOfBy arg-2 arg-3 eta-0)) (DataC-45List-tails arg-4))))
(define DataC-45List-isInfixOf (lambda (arg-1 ext-0 ext-1) (DataC-45List-isInfixOfBy (let ((e-1 (car arg-1))) e-1) ext-0 ext-1)))
(define DataC-45String-isInfixOf (lambda (arg-0 arg-1) (DataC-45List-isInfixOf csegen-39 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
(define CoverageC-45TestsC-45SourceAnalyzerTest-case--testSignatures-9588 (lambda (arg-0 arg-1) (if (null? arg-1) (lambda () (force csegen-1)) (let ((e-2 (unbox arg-1))) (let ((e-1 (vector-ref e-2 1))) (if (null? e-1) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] add has no signature\xa;" eta-0))) (let ((e-6 (unbox e-1))) (lambda () (lambda (eta-0) (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "add signature contains Int" (DataC-45String-isInfixOf "Int" e-6) eta-0))))))))))
...
(define CoverageC-45TestsC-45SourceAnalyzerTest-case--testLineRanges-9527 (lambda (arg-0 arg-1) (if (null? arg-1) (lambda () (force csegen-1)) (let ((e-2 (unbox arg-1))) (lambda () (lambda (world-0) (let ((act-1 (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "add has lineStart" (PreludeC-45Types-u--C-62_Ord_Nat (let ((e-5 (vector-ref e-2 2))) e-5) 0) world-0))) (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "add has lineEnd >= lineStart" (PreludeC-45Types-u--C-62C-61_Ord_Nat (let ((e-3 (vector-ref e-2 3))) e-3) (let ((e-5 (vector-ref e-2 2))) e-5)) world-0))))))))
...
(define DataC-45String-isPrefixOf (lambda (arg-0 arg-1) (DataC-45List-isPrefixOf csegen-39 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define CoverageC-45SourceAnalyzer-extractSignature (lambda (arg-0) (let ((u--parts (DataC-45List-break csegen-44 (PreludeC-45Types-fastUnpack arg-0)))) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List (Builtin-snd u--parts)))) (cond ((equal? sc0 1) '()) (else (box (DataC-45String-trim (PreludeC-45Types-fastPack (DataC-45List-drop 1 (Builtin-snd u--parts)))))))))))
...
(define CoverageC-45TestsC-45SourceAnalyzerTest-sampleIdrisSource (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) "") (lambda (eta-0) eta-0) (cons "module Sample\xa;\xa;export\xa;add : Int -> Int -> Int\xa;add x y = x + y\xa;\xa;export\xa;multiply : Int -> Int -> Int\xa;multiply x y = x * y\xa;\xa;private\xa;helper : Int -> Int\xa;helper x = x\xa;\xa;export\xa;factorial : Int -> Int\xa;factorial 0 = 1\xa;factorial n = n * factorial (n - 1)" '())))
(define CoverageC-45TestsC-45SourceAnalyzerTest-testSignatures (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_SRC_003: signatures --\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource CoverageC-45TestsC-45SourceAnalyzerTest-sampleIdrisSource))) (CoverageC-45TestsC-45SourceAnalyzerTest-case--testSignatures-9588 u--funcs (DataC-45List-find csegen-3 u--funcs)))) ext-0))))
(define CoverageC-45TestsC-45SourceAnalyzerTest-testMultiLine (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_SRC_004: multi-line --\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource CoverageC-45TestsC-45SourceAnalyzerTest-sampleIdrisSource))) (CoverageC-45TestsC-45SourceAnalyzerTest-case--testMultiLine-9662 u--funcs (DataC-45List-find (lambda (u--f) (PreludeC-45EqOrd-u--C-61C-61_Eq_String (let ((e-0 (vector-ref u--f 0))) e-0) "factorial")) u--funcs)))) ext-0))))
(define CoverageC-45TestsC-45SourceAnalyzerTest-testLineRanges (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_SRC_002: line ranges --\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource CoverageC-45TestsC-45SourceAnalyzerTest-sampleIdrisSource))) (CoverageC-45TestsC-45SourceAnalyzerTest-case--testLineRanges-9527 u--funcs (DataC-45List-find csegen-3 u--funcs)))) ext-0))))
...
(define CoverageC-45TestsC-45SourceAnalyzerTest-testExtractModuleName (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- extractModuleName --\xa;" ext-0))) (((let ((sc0 (CoverageC-45SourceAnalyzer-extractModuleName CoverageC-45TestsC-45SourceAnalyzerTest-sampleIdrisSource))) (if (null? sc0) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr "[FAIL] module name not found\xa;" eta-0))) (let ((e-2 (unbox sc0))) (lambda () (lambda (eta-0) (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "module name is Sample" (PreludeC-45EqOrd-u--C-61C-61_Eq_String e-2 "Sample") eta-0))))))) ext-0))))
(define PreludeC-45Types-elemBy (lambda (arg-2 arg-3 arg-4) (let ((e-6 (vector-ref arg-2 5))) ((((e-6 'erased) 'erased) csegen-41) (arg-3 arg-4)))))
...
(define CoverageC-45TestsC-45SourceAnalyzerTest-testExportExtraction (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_SRC_001: extract exports --\xa;" ext-0))) (((let ((u--funcs (CoverageC-45SourceAnalyzer-analyzeSource CoverageC-45TestsC-45SourceAnalyzerTest-sampleIdrisSource))) (let ((u--names (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (let ((e-0 (vector-ref eta-0 0))) e-0)) u--funcs))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "finds add function" ((PreludeC-45Types-elem (force csegen-25) (force csegen-28) "add") u--names) world-0))) (let ((act-3 (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "finds multiply function" ((PreludeC-45Types-elem (force csegen-25) (force csegen-28) "multiply") u--names) world-0))) (let ((act-4 (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "finds factorial function" ((PreludeC-45Types-elem (force csegen-25) (force csegen-28) "factorial") u--names) world-0))) (let ((act-5 (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "does not find private helper" (let ((sc0 ((PreludeC-45Types-elem (force csegen-25) (force csegen-28) "helper") u--names))) (cond ((equal? sc0 1) 0) (else 1))) world-0))) (CoverageC-45TestsC-45SourceAnalyzerTest-assertTrue "finds exactly 3 exported functions" (or (and (= (PreludeC-45TypesC-45List-lengthTR u--funcs) 3) 1) 0) world-0)))))))))) ext-0))))
(define CoverageC-45TestsC-45SourceAnalyzerTest-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== SourceAnalyzerTest ===\xa;" ext-0))) (let ((act-2 (CoverageC-45TestsC-45SourceAnalyzerTest-testExportExtraction ext-0))) (let ((act-3 (CoverageC-45TestsC-45SourceAnalyzerTest-testLineRanges ext-0))) (let ((act-4 (CoverageC-45TestsC-45SourceAnalyzerTest-testSignatures ext-0))) (let ((act-5 (CoverageC-45TestsC-45SourceAnalyzerTest-testMultiLine ext-0))) (let ((act-6 (CoverageC-45TestsC-45SourceAnalyzerTest-testExtractModuleName ext-0))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" ext-0)))))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (CoverageC-45TestsC-45SourceAnalyzerTest-main eta-0)))
