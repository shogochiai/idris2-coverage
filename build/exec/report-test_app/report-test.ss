...
(define csegen-19 (cons (lambda (arg-8505) (lambda (arg-8508) (string-append arg-8505 arg-8508))) ""))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define CoverageC-45TestsC-45ReportTest-assertTrue (lambda (arg-0 arg-1 ext-0) (cond ((equal? arg-1 1) (PreludeC-45IO-prim__putStr (string-append (string-append "[PASS] " arg-0) "\xa;") ext-0)) (else (PreludeC-45IO-prim__putStr (string-append (string-append "[FAIL] " arg-0) "\xa;") ext-0)))))
...
(define CoverageC-45Report-maybeStringJson (lambda (arg-0) (if (null? arg-0) "null" (let ((e-2 (unbox arg-0))) (PreludeC-45Types-u--foldMap_Foldable_List csegen-19 (lambda (eta-0) eta-0) (cons "\"" (cons (CoverageC-45Report-escapeJson e-2) (cons "\"" '()))))))))
...
(define CoverageC-45Report-stringListJson (lambda (arg-0) (string-append "[" (string-append (PreludeC-45Types-fastConcat (DataC-45List-intersperse ", " (PreludeC-45TypesC-45List-mapAppend '() (lambda (u--s) (PreludeC-45Types-u--foldMap_Foldable_List csegen-19 (lambda (eta-0) eta-0) (cons "\"" (cons (CoverageC-45Report-escapeJson u--s) (cons "\"" '()))))) arg-0))) "]"))))
...
(define CoverageC-45Report-n--4532-6066-u--formatUncovered (lambda (arg-0 arg-1 arg-2) (PreludeC-45Types-u--foldMap_Foldable_List csegen-19 (lambda (eta-0) eta-0) (cons "  " (cons (let ((e-0 (vector-ref arg-2 0))) e-0) (cons "." (cons (let ((e-1 (vector-ref arg-2 1))) e-1) (cons " (line " (cons (PreludeC-45Types-maybe (lambda () "?") (lambda () (lambda (eta-0) (PreludeC-45Show-u--show_Show_Nat eta-0))) (let ((e-3 (vector-ref arg-2 3))) e-3)) (cons ")\xa;" '()))))))))))
...
(define CoverageC-45TestsC-45ReportTest-sampleFunc (vector "Sample" "add" (box "Int -> Int -> Int") (box 5) (box 7) 3 3 100.0 (cons "test_add" (cons "test_math" '()))))
(define CoverageC-45TestsC-45ReportTest-sampleModule (vector "src/Sample.idr" 3 2 66.67))
(define CoverageC-45TestsC-45ReportTest-sampleProject (vector 10 8 80.0 '()))
(define CoverageC-45TestsC-45ReportTest-sampleReport (vector (cons CoverageC-45TestsC-45ReportTest-sampleFunc '()) (cons CoverageC-45TestsC-45ReportTest-sampleModule '()) CoverageC-45TestsC-45ReportTest-sampleProject))
(define CoverageC-45TestsC-45ReportTest-testGenerateReport (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- generateReport --\xa;" ext-0))) (((let ((u--jsonOut (CoverageC-45Report-generateReport 0 CoverageC-45TestsC-45ReportTest-sampleReport))) (let ((u--textOut (CoverageC-45Report-generateReport 1 CoverageC-45TestsC-45ReportTest-sampleReport))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45ReportTest-assertTrue "JSON format produces JSON" (DataC-45String-isInfixOf "{" u--jsonOut) world-0))) (CoverageC-45TestsC-45ReportTest-assertTrue "Text format produces text" (DataC-45String-isInfixOf "Summary" u--textOut) world-0))))))) ext-0))))
(define CoverageC-45TestsC-45ReportTest-testFunctionCoverageJson (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_REP_001: functionCoverageJson --\xa;" ext-0))) (((let ((u--json (CoverageC-45Report-functionCoverageJson CoverageC-45TestsC-45ReportTest-sampleFunc))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45ReportTest-assertTrue "contains module field" (DataC-45String-isInfixOf "\"module\"" u--json) world-0))) (let ((act-3 (CoverageC-45TestsC-45ReportTest-assertTrue "contains name field" (DataC-45String-isInfixOf "\"name\"" u--json) world-0))) (let ((act-4 (CoverageC-45TestsC-45ReportTest-assertTrue "contains called_by_tests" (DataC-45String-isInfixOf "called_by_tests" u--json) world-0))) (CoverageC-45TestsC-45ReportTest-assertTrue "contains test_add" (DataC-45String-isInfixOf "test_add" u--json) world-0)))))))) ext-0))))
(define CoverageC-45TestsC-45ReportTest-testCoverageReportText (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_REP_002: coverageReportText --\xa;" ext-0))) (((let ((u--text (CoverageC-45Report-coverageReportText CoverageC-45TestsC-45ReportTest-sampleReport))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45ReportTest-assertTrue "contains Project Summary" (DataC-45String-isInfixOf "Project Summary" u--text) world-0))) (CoverageC-45TestsC-45ReportTest-assertTrue "contains Modules section" (DataC-45String-isInfixOf "Modules" u--text) world-0)))))) ext-0))))
(define CoverageC-45TestsC-45ReportTest-testCoverageReportJson (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_REP_001: coverageReportJson --\xa;" ext-0))) (((let ((u--json (CoverageC-45Report-coverageReportJson CoverageC-45TestsC-45ReportTest-sampleReport))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45ReportTest-assertTrue "contains functions array" (DataC-45String-isInfixOf "\"functions\"" u--json) world-0))) (let ((act-3 (CoverageC-45TestsC-45ReportTest-assertTrue "contains modules array" (DataC-45String-isInfixOf "\"modules\"" u--json) world-0))) (CoverageC-45TestsC-45ReportTest-assertTrue "contains project object" (DataC-45String-isInfixOf "\"project\"" u--json) world-0))))))) ext-0))))
(define CoverageC-45TestsC-45ReportTest-testAllRequiredFields (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "-- REQ_COV_REP_003: all required fields --\xa;" ext-0))) (((let ((u--json (CoverageC-45Report-coverageReportJson CoverageC-45TestsC-45ReportTest-sampleReport))) (lambda () (lambda (world-0) (let ((act-2 (CoverageC-45TestsC-45ReportTest-assertTrue "has line_start" (DataC-45String-isInfixOf "line_start" u--json) world-0))) (let ((act-3 (CoverageC-45TestsC-45ReportTest-assertTrue "has line_end" (DataC-45String-isInfixOf "line_end" u--json) world-0))) (let ((act-4 (CoverageC-45TestsC-45ReportTest-assertTrue "has coverage_percent" (DataC-45String-isInfixOf "coverage_percent" u--json) world-0))) (let ((act-5 (CoverageC-45TestsC-45ReportTest-assertTrue "has total_functions" (DataC-45String-isInfixOf "total_functions" u--json) world-0))) (CoverageC-45TestsC-45ReportTest-assertTrue "has covered_functions" (DataC-45String-isInfixOf "covered_functions" u--json) world-0))))))))) ext-0))))
(define CoverageC-45TestsC-45ReportTest-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== ReportTest ===\xa;" ext-0))) (let ((act-2 (CoverageC-45TestsC-45ReportTest-testFunctionCoverageJson ext-0))) (let ((act-3 (CoverageC-45TestsC-45ReportTest-testCoverageReportJson ext-0))) (let ((act-4 (CoverageC-45TestsC-45ReportTest-testCoverageReportText ext-0))) (let ((act-5 (CoverageC-45TestsC-45ReportTest-testAllRequiredFields ext-0))) (let ((act-6 (CoverageC-45TestsC-45ReportTest-testGenerateReport ext-0))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" ext-0)))))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (CoverageC-45TestsC-45ReportTest-main eta-0)))
