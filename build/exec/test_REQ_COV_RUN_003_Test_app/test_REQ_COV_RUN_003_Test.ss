...
(define csegen-4 (vector (lambda (arg-5927) (lambda (arg-5930) (+ arg-5927 arg-5930))) (lambda (arg-5937) (lambda (arg-5940) (* arg-5937 arg-5940))) (lambda (arg-5947) (PreludeC-45Types-prim__integerToNat arg-5947))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== REQ_COV_RUN_003 Test ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Testing: Profile capture\xa;" ext-0))) (((let ((u--exprs (CoverageC-45Collector-parseAnnotatedHtml "<span title=\"line 1 char 1 count 10\">x</span>"))) (lambda () (lambda (world-0) (let ((act-3 (let ((sc0 (or (and (= (PreludeC-45TypesC-45List-lengthTR u--exprs) 1) 1) 0))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "[PASS] Profile capture parsing works\xa;" world-0)) (else (PreludeC-45IO-prim__putStr "[FAIL] Capture failed\xa;" world-0)))))) (PreludeC-45IO-prim__putStr "=== Done ===\xa;" world-0)))))) ext-0)))))
